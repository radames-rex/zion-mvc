<?php
/**
 * MatrixMainController - Todos os controllers deverão estender essa classe
 *
 * @package HamsahMVC
 * @since 0.1
 */
class MatrixMainController extends MatrixUserLogin
{
