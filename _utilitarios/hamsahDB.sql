...
-- Copiando estrutura do banco de dados para hamsah
CREATE DATABASE IF NOT EXISTS `hamsah` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `hamsah`;


-- Copiando estrutura para tabela hamsah.admins
CREATE TABLE IF NOT EXISTS `admins` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) COLLATE utf8_bin NOT NULL,
  `telefone` varchar(11) COLLATE utf8_bin DEFAULT '0',
...
-- Copiando dados para a tabela hamsah.admins: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `admins` DISABLE KEYS */;
INSERT INTO `admins` (`id`, `nome`, `telefone`, `senha`, `session_id`, `permissions`, `data_inclusao`) VALUES
	(1, 'radames', '86998666350', '$2a$08$25PoPvz1HGGCIlEa4jjELOEdyL3OsHbTY.q4zdszWaXyU9lPw57Gi', 'b8999c241b39579ebfcf4e78f4429ed7', 'a:4:{i:0;s:4:"link";i:1;s:7:"trinity";i:2;s:8:"morpheus";i:3;s:3:"neo";}', '2015-12-14 18:28:02'),
	(2, 'pabliane', '86999691138', '$2a$08$riIWzQm5SUtWib9uq8AVuOXBN/JsXiPEeiKFwBr4n.DCCJWRG4FRq', '7isfssek1bmcevljnumas70gc6', 'a:4:{i:0;s:4:"link";i:1;s:7:"trinity";i:2;s:8:"morpheus";i:3;s:3:"neo";}', '2015-12-14 18:13:30');
/*!40000 ALTER TABLE `admins` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.categorias
...
-- Copiando dados para a tabela hamsah.categorias: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `categorias` DISABLE KEYS */;
/*!40000 ALTER TABLE `categorias` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.cidades
...
-- Copiando dados para a tabela hamsah.cidades: ~5.564 rows (aproximadamente)
...
-- Copiando estrutura para tabela hamsah.clientes
CREATE TABLE IF NOT EXISTS `clientes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) COLLATE utf8_bin NOT NULL,
  `email` varchar(100) COLLATE utf8_bin NOT NULL,
  `sexo` char(1) COLLATE utf8_bin NOT NULL COMMENT 'm: masculino f:feminino',
  `cpf` int(11) NOT NULL,
  `senha` varchar(255) COLLATE utf8_bin NOT NULL,
  `session_id` varchar(255) COLLATE utf8_bin NOT NULL,
  `permissions` longtext COLLATE utf8_bin NOT NULL,
  `data_nascimento` date NOT NULL DEFAULT '0000-00-00',
  `telefone_id` int(11) DEFAULT '0',
  `endereco_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_clientes_telefones` (`telefone_id`),
  KEY `FK_clientes_enderecos` (`endereco_id`),
  CONSTRAINT `FK_clientes_enderecos` FOREIGN KEY (`endereco_id`) REFERENCES `enderecos` (`id`),
  CONSTRAINT `FK_clientes_telefones` FOREIGN KEY (`telefone_id`) REFERENCES `telefones` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.clientes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.comentarios
CREATE TABLE IF NOT EXISTS `comentarios` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `comentario` text COLLATE utf8_bin NOT NULL,
  `data_inclusao` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `cliente_id` int(11) DEFAULT '0',
  `produto_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_comentarios_produtos` (`produto_id`),
  KEY `FK_comentarios_clientes` (`cliente_id`),
  CONSTRAINT `FK_comentarios_clientes` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `FK_comentarios_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.comentarios: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `comentarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `comentarios` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.cores
...
-- Copiando dados para a tabela hamsah.cores: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `cores` DISABLE KEYS */;
/*!40000 ALTER TABLE `cores` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.enderecos
CREATE TABLE IF NOT EXISTS `enderecos` (
  ...
  `estado_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_enderecos_cidades` (`cidade_id`),
  KEY `FK_enderecos_estados` (`estado_id`),
  CONSTRAINT `FK_enderecos_cidades` FOREIGN KEY (`cidade_id`) REFERENCES `cidades` (`id`),
  CONSTRAINT `FK_enderecos_estados` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.enderecos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `enderecos` DISABLE KEYS */;
/*!40000 ALTER TABLE `enderecos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.entrega_enderecos
CREATE TABLE IF NOT EXISTS `entrega_enderecos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `endereco` varchar(255) COLLATE utf8_bin NOT NULL,
  `numero` int(11) NOT NULL,
  `complemento` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  ...
  KEY `FK_enderecos_cidades` (`cidade_id`),
  KEY `FK_enderecos_estados` (`estado_id`),
  KEY `FK_entrega_enderecos_pedidos` (`pedido_id`),
  CONSTRAINT `FK_entrega_enderecos_cidades` FOREIGN KEY (`cidade_id`) REFERENCES `cidades` (`id`),
  CONSTRAINT `FK_entrega_enderecos_estados` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`),
  CONSTRAINT `FK_entrega_enderecos_pedidos` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT;

-- Copiando dados para a tabela hamsah.entrega_enderecos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `entrega_enderecos` DISABLE KEYS */;
/*!40000 ALTER TABLE `entrega_enderecos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.estados
...
-- Copiando dados para a tabela hamsah.estados: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela hamsah.estoques
...
-- Copiando dados para a tabela hamsah.estoques: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `estoques` DISABLE KEYS */;
/*!40000 ALTER TABLE `estoques` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.estoque_logs
CREATE TABLE IF NOT EXISTS `estoque_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data_inclusao` datetime NOT NULL,
  `quantidade` int(11) NOT NULL,
  `tipo` tinyint(4) NOT NULL COMMENT '1:entrada 2:saida',
  `estoque_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_estoques_logs_estoques` (`estoque_id`),
  CONSTRAINT `FK_estoques_logs_estoques` FOREIGN KEY (`estoque_id`) REFERENCES `estoques` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.estoque_logs: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `estoque_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `estoque_logs` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.favoritos
CREATE TABLE IF NOT EXISTS `favoritos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cliente_id` int(11) DEFAULT '0',
  `produto_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_favoritos_clientes` (`cliente_id`),
  KEY `FK_favoritos_produtos` (`produto_id`),
  CONSTRAINT `FK_favoritos_clientes` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `FK_favoritos_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.favoritos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `favoritos` DISABLE KEYS */;
/*!40000 ALTER TABLE `favoritos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.fotos
CREATE TABLE IF NOT EXISTS `fotos` (
  ...
  `produto_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_fotos_produtos` (`produto_id`),
  KEY `FK_fotos_cores` (`cor_id`),
  CONSTRAINT `FK_fotos_cores` FOREIGN KEY (`cor_id`) REFERENCES `cores` (`id`),
  CONSTRAINT `FK_fotos_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.fotos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fotos` DISABLE KEYS */;
/*!40000 ALTER TABLE `fotos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.fretes
CREATE TABLE IF NOT EXISTS `fretes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `faixa_cep_de` int(11) NOT NULL,
  `faixa_cep_ate` int(11) NOT NULL,
  `valor` double NOT NULL,
  `transporte_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_fretes_transportes` (`transporte_id`),
  CONSTRAINT `FK_fretes_transportes` FOREIGN KEY (`transporte_id`) REFERENCES `transportes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.fretes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fretes` DISABLE KEYS */;
/*!40000 ALTER TABLE `fretes` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.galeria_fotos
...
-- Copiando dados para a tabela hamsah.galeria_fotos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `galeria_fotos` DISABLE KEYS */;
/*!40000 ALTER TABLE `galeria_fotos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.galeria_videos
...
-- Copiando dados para a tabela hamsah.galeria_videos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `galeria_videos` DISABLE KEYS */;
/*!40000 ALTER TABLE `galeria_videos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.looks
...
-- Copiando dados para a tabela hamsah.looks: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `looks` DISABLE KEYS */;
/*!40000 ALTER TABLE `looks` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.looks_produtos
CREATE TABLE IF NOT EXISTS `looks_produtos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parte_do_corpo` tinyint(4) DEFAULT '0' COMMENT '0:cabeca 1:pescoco 2:bracos 3:top 4:bottom 5:calcado',
  `produto_id` int(11) DEFAULT '0',
  `look_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_looks_produtos_produtos` (`produto_id`),
  KEY `FK_looks_produtos_looks` (`look_id`),
  CONSTRAINT `FK_looks_produtos_looks` FOREIGN KEY (`look_id`) REFERENCES `looks` (`id`),
  CONSTRAINT `FK_looks_produtos_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.looks_produtos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `looks_produtos` DISABLE KEYS */;
/*!40000 ALTER TABLE `looks_produtos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.mensagens
CREATE TABLE IF NOT EXISTS `mensagens` (
  ...
  `pedido_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_mensagens_clientes` (`cliente_id`),
  KEY `FK_mensagens_admins` (`admin_id`),
  KEY `FK_mensagens_pedidos` (`pedido_id`),
  CONSTRAINT `FK_mensagens_admins` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`),
  CONSTRAINT `FK_mensagens_clientes` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `FK_mensagens_pedidos` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.mensagens: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `mensagens` DISABLE KEYS */;
/*!40000 ALTER TABLE `mensagens` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.newsletters
...
-- Copiando dados para a tabela hamsah.newsletters: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `newsletters` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletters` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pagamentos
CREATE TABLE IF NOT EXISTS `pagamentos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `valor_pago` int(11) NOT NULL,
  `data_inclusao` datetime NOT NULL,
  `data_upgrade` datetime DEFAULT '0000-00-00 00:00:00',
  `pedido_id` int(11) NOT NULL DEFAULT '0',
  `pagamento_status_id` int(11) NOT NULL DEFAULT '0',
  `pagamento_tipo_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_pagamentos_pagamento_status` (`pagamento_status_id`),
  KEY `FK_pagamentos_pagamento_tipos` (`pagamento_tipo_id`),
  KEY `FK_pagamentos_pedidos` (`pedido_id`),
  CONSTRAINT `FK_pagamentos_pagamento_status` FOREIGN KEY (`pagamento_status_id`) REFERENCES `pagamento_status` (`id`),
  CONSTRAINT `FK_pagamentos_pagamento_tipos` FOREIGN KEY (`pagamento_tipo_id`) REFERENCES `pagamento_tipos` (`id`),
  CONSTRAINT `FK_pagamentos_pedidos` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pagamentos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pagamentos` DISABLE KEYS */;
/*!40000 ALTER TABLE `pagamentos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pagamento_status
...
-- Copiando dados para a tabela hamsah.pagamento_status: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pagamento_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `pagamento_status` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pagamento_tipos
CREATE TABLE IF NOT EXISTS `pagamento_tipos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pagamento_tipos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pagamento_tipos` DISABLE KEYS */;
/*!40000 ALTER TABLE `pagamento_tipos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.paises
...
-- Copiando dados para a tabela hamsah.paises: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela hamsah.pedidos
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `cliente_id` int(11) DEFAULT '0',
  `pedido_status_id` int(11) DEFAULT '0',
  `frete_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_pedidos_clientes` (`cliente_id`),
  KEY `FK_pedidos_pedido_status` (`pedido_status_id`),
  KEY `FK_pedidos_fretes` (`frete_id`),
  CONSTRAINT `FK_pedidos_clientes` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `FK_pedidos_fretes` FOREIGN KEY (`frete_id`) REFERENCES `fretes` (`id`),
  CONSTRAINT `FK_pedidos_pedido_status` FOREIGN KEY (`pedido_status_id`) REFERENCES `pedido_status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pedidos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedidos` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedidos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pedido_item_status
CREATE TABLE IF NOT EXISTS `pedido_item_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pedido_item_status: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido_item_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_item_status` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pedido_itens
CREATE TABLE IF NOT EXISTS `pedido_itens` (
  ...
  `pedido_id` int(11) DEFAULT '0',
  `produto_id` int(11) DEFAULT '0',
  `pedido_item_status_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_pedido_itens_pedidos` (`pedido_id`),
  KEY `FK_pedido_itens_produtos` (`produto_id`),
  KEY `FK_pedido_itens_pedido_item_status` (`pedido_item_status_id`),
  CONSTRAINT `FK_pedido_itens_pedidos` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`),
  CONSTRAINT `FK_pedido_itens_pedido_item_status` FOREIGN KEY (`pedido_item_status_id`) REFERENCES `pedido_item_status` (`id`),
  CONSTRAINT `FK_pedido_itens_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pedido_itens: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido_itens` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_itens` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pedido_logs
CREATE TABLE IF NOT EXISTS `pedido_logs` (
  ...
  `pedido_status_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_pedido_logs_pedidos` (`pedido_id`),
  KEY `FK_pedido_logs_pedido_status` (`pedido_status_id`),
  CONSTRAINT `FK_pedido_logs_pedidos` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`),
  CONSTRAINT `FK_pedido_logs_pedido_status` FOREIGN KEY (`pedido_status_id`) REFERENCES `pedido_status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pedido_logs: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_logs` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.pedido_status
CREATE TABLE IF NOT EXISTS `pedido_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) COLLATE utf8_bin NOT NULL,
  `descricao` varchar(255) COLLATE utf8_bin NOT NULL,
  `polaridade` tinyint(4) NOT NULL COMMENT '0:pendente 1:pago -1:nao pago',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.pedido_status: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_status` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.produtos
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  `valor` double NOT NULL,
  `peso` int(11) NOT NULL COMMENT 'em gramas',
  `tamanho` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `material` varchar(100) COLLATE utf8_bin NOT NULL,
  `desconto` double DEFAULT '0' COMMENT 'em %',
  `curtidas` int(11) DEFAULT '0',
...
-- Copiando dados para a tabela hamsah.produtos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `produtos` DISABLE KEYS */;
/*!40000 ALTER TABLE `produtos` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.produto_cores
CREATE TABLE IF NOT EXISTS `produto_cores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cor_id` int(11) DEFAULT '0',
  `produto_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_produto_cores_cores` (`cor_id`),
  KEY `FK_produto_cores_produtos` (`produto_id`),
  CONSTRAINT `FK_produto_cores_cores` FOREIGN KEY (`cor_id`) REFERENCES `cores` (`id`),
  CONSTRAINT `FK_produto_cores_produtos` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.produto_cores: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `produto_cores` DISABLE KEYS */;
/*!40000 ALTER TABLE `produto_cores` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.telefones
CREATE TABLE IF NOT EXISTS `telefones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fixo` varchar(11) COLLATE utf8_bin NOT NULL,
  `celular` varchar(11) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.telefones: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `telefones` DISABLE KEYS */;
/*!40000 ALTER TABLE `telefones` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.temas
CREATE TABLE IF NOT EXISTS `temas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) COLLATE utf8_bin NOT NULL,
  `ativo` tinyint(4) NOT NULL COMMENT '1:ativo 0:inativo',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Copiando dados para a tabela hamsah.temas: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `temas` DISABLE KEYS */;
/*!40000 ALTER TABLE `temas` ENABLE KEYS */;


-- Copiando estrutura para tabela hamsah.transportes
...
-- Copiando dados para a tabela hamsah.transportes: ~0 rows (aproximadamente)
